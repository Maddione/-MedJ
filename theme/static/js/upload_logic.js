(function(){
  ...
  function setDisabledLabel(labelEl,d){if(!labelEl)return; if(d){labelEl.classList.add("disabled-ui");labelEl.setAttribute("data-disabled","true")}else{labelEl.classList.remove("disabled-ui");labelEl.removeAttribute("data-disabled")}}
  ...
  function sync(){
    ...
    setDisabledLabel(fileBtn,!step3);
